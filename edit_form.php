...
/**
 * Adds new instance of enrol_ipay to specified course
...
class enrol_ipay_edit_form extends moodleform {
    ...
    function definition() {
        ...
        $mform->setDefault('businessname', $plugin->get_config('businessname'));//this faetches from the configured setings the business name
    ...
    function validation($data, $files) {
        ...
        if (!empty($data['enrolenddate']) and $data['enrolenddate'] < $data['enrolstartdate']) {
            $errors['enrolenddate'] = get_string('enrolenddaterror', 'enrol_ipay');
        }

        $cost = str_replace(get_string('decsep', 'langconfig'), '.', $data['cost']);
        if (!is_numeric($cost)) {
            $errors['cost'] = get_string('costerror', 'enrol_ipay');
        }
